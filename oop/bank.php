...
class Bank {
    ...
    function __construct($accountNum, $name){
...
$bank1 = new Bank("0123456789", "fred hammond");
$bank1->depositAmount(500)->checkBalance();
$bank1->deductedAmount(100)->checkBalance();
$bank1->deductedAmount(1000)->checkBalance();
// echo $bank1->deductedAmount(1000)->checkBalance();
